...
<div id="container">
	<div>
		<form action="/usedFact_hyoji.php" method="post">
<div class="row">
	費用項目1
...
<!-- 	<div id="btn">登録</div>
	...
	<form action="/usedFact_hyoji.php?yy=$yy&mm=$mm&dd=$dd" name="form_name_<?php echo $hyoji->id; ?>" id="form_name_<?php echo $hyoji->id; ?>" data-id="<?php echo $hyoji->id; ?>" method="post">
	費用項目1
...
<a href="/index_calendar.php">カレンダーの画面</a>
