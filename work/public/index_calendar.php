...
$komoku = new MyApp\Controller\IndexCalendar();
...
$getBody = $komoku->getBody($y,$m);

// $hyouji_ichiran = $komoku->hyoji_ichiran($y,$m);
$hyouji_ichiran = $komoku->getValues()->hyojiIchiran;
...
$gokei = $komoku->tuki_gokei($y,$m);
 ...
 <div id="container">
     ...
     <table border="1" style="font-size: 12px;">
        <thead>
            <tr>
            <th><a href="/index_calendar.php?t=<?php echo $prev; ?>">前月</a></th>
            <th colspan="5"><?php echo($y.'年'.$m.'月');?></th>
            <th><a href="/index_calendar.php?t=<?php echo $next; ?>">次月</a></th>
            </tr>
        </thead>
        <tbody>
        <tr>
