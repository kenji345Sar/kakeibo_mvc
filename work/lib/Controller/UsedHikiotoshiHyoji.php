...
class UsedHikiotoshiHyoji extends \MyApp\Controller {

    public function run($post,$yy,$mm,$dd){

        $hyoji = new \MyApp\Model\BankInOut();
...
// var_dump($_POST);
    ...
    public function add($post){
      if(isset($post) && !empty($post) && $post['way'] == 'add'){
        ...
        $komokuApp = new \MyApp\Model\BankInOut();
    ...
    public function select_Name(){
       ...
       $tag2name = new \MyApp\Model\Tag2Name();

       $koumoku1 = array();
        // $komokuApp = new \MyApp\Komoku();

        $koumokus = $tag2name->tag2Name();
